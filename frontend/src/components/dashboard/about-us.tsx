    ...
    <Box sx={{ padding: "50px 0" }}>
      <Container maxWidth="md">
        ...
        <Box sx={{ textAlign: "center", marginBottom: "50px" }}>
          ...
          <Typography variant="body1" paragraph align="justify">
            We're on a quest to transform the way you experience books and
            videos. Our intelligent recommendation engine understands your
            emotions by detecting and recognizing your facial emotions and
            guides you to content that lifts your spirits, soothes your soul, or
            takes you on a thrilling adventure.
          </Typography>
        </Box>
            ...
            <Card sx={{ borderRadius: 3 }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" align="justify">
                  Capture your live photo or upload a photo to detect your
                  emotions.
                </Typography>
              </CardContent>
            </Card>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderRadius: 3 }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" align="justify">
                  Choose your mood and get personalized book and video
                  recommendations.
                </Typography>
              </CardContent>
            </Card>
            ...
            <Card sx={{ borderRadius: 3 }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2">
                  After analyzing your emotions, we recommend books and videos
