...
export default function SurpriseBooks() {
    const [books, setBooks] = useState<Record<string, BookData[]>>({});
  const [hasMore, setHasMore] = useState(true); 

  useEffect(() => {
    const queries = ['Mystery', 'Thriller', 'Speculative' , 'Fiction', 'Unexpected', 'Wonder', 'Non-Fiction' , 'Page-Turner', 'Twists', 'Unforgettable']; 
