...
const BookCategories = [
  ...
  {
    title: "Fear: Turn those goosebumps into laughter. It's book therapy time!",
    path: paths.recommendation.books.fear,
    image: "/assets/fear/img.jpg",
  },
  {
    title: "Sad: Turn your blues into hues with these uplifting Books.",
  ...
  {
    title:
      "Neutral: Open the door to endless possibilities. Click read and let the adventure begin.",
