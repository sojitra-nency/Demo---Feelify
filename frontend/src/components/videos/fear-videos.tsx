...
export default function FearVideos() {
    const [videos, setVideos] = useState<Record<string, VideoData[]>>({});
  const [hasMore, setHasMore] = useState(true); 

  useEffect(() => {
    const queries = ['anxietyrelief', 'calmingmusic', 'guidedmeditation' , 'copingwithfear', 'overcominganxiety', 'stressmanagement', 'relaxationtechniques' , 'mindfulnesspractices', 'selfcaretips', 'inspirationalstories']; 
