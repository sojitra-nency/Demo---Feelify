...
export default function SurpriseVideos() {
    const [videos, setVideos] = useState<Record<string, VideoData[]>>({});
  const [hasMore, setHasMore] = useState(true); 

  useEffect(() => {
    const queries = ['Unexpected', 'MindBlown', 'Unbelievable' , 'Jawdropping', 'WhatJustHappened', 'Amazing', 'Shocking' , 'OMG', 'WTF', 'SurpriseReaction']; 
