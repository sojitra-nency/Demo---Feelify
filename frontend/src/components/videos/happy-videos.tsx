...
export default function HappyVideos() {
    const [videos, setVideos] = useState<Record<string, VideoData[]>>({});
  const [hasMore, setHasMore] = useState(true); 

  useEffect(() => {
    const queries = ['JoyfulMoments', 'HappinessBoost', 'CelebratingLife' , 'PositiveVibes', 'GoodMoodMusic', 'InspiringStories', 'lifestyle' , 'Travel', 'Adventure', 'UpliftingMusic']; 
