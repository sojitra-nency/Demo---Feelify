...
export default function SadVideos() {
    const [videos, setVideos] = useState<Record<string, VideoData[]>>({});
  const [hasMore, setHasMore] = useState(true); 

  useEffect(() => {
    const queries = ['relaxingmusic', 'motivation', 'comforting' , 'nature', 'wholesome', 'lofihiphop', 'meditation' , 'storytime', 'mentalhealth', 'gaming']; 
