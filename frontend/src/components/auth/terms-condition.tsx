  ...
  return (
    <div>
      ...
      <Typography variant="body1" paragraph textAlign="justify">
        ...
        conditions in full. Do not continue to use our website if you do not
        accept all of the terms and conditions stated on this page.
      </Typography>
      <Typography variant="body1" paragraph textAlign="justify">
        Read our full <Link color="primary">Privacy Policy</Link> to know more
        about how we handle your personal information.
      </Typography>
      <Typography variant="body1" paragraph textAlign="justify">
        We employ the use of cookies. By using our website you consent to the
